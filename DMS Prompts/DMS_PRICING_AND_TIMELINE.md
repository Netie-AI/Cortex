...
## 6. Hardware — what it actually costs, and who buys it

Verified street prices, July 2026, converted at ≈RM 4.70/USD:

| Tier | Spec | USD | **MYR** |
|---|---|---|---|
| Entry | Ryzen 7, RTX 4070 12GB, 32GB RAM, 2TB NVMe | $1,500–2,000 | **RM 7,000–9,500** |
| **Target — 500GB–2TB working set** | Ryzen 9 / i9, RTX 4070–4080, 128GB RAM, 4TB NVMe | $3,500–5,000 | **RM 16,500–23,500** |
| Growth — 2–20TB | server-class, 256GB ECC RAM, 32 cores, NVMe array | $8,000–14,000 | **RM 37,500–66,000** |
