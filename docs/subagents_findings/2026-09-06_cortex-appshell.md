...
- **Verify:** `python -m pytest tests/test_crew -q` (250 passed locally after rebase onto #193)
- **Does not prove:** live `:8020` (not started); Control `:8040` up; GitHub CI; bottom-nav PWA beyond a tiny webmanifest
- **Cite:** CORTEX-APPSHELL week IA; off freeze #4/#41-#44; rebased after #193 LIFE-HARDEN and #192 FACTS-MD
