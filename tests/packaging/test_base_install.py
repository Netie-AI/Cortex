...
BASE_MODULES = [
    ...
    "packages.cortex_contract.version",
    "packages.cortex_contract.answer",
    "packages.cortex_contract.execution",
    "packages.cortex_contract.ledger",
    "packages.cortex_contract.proposal",
    "packages.cortex_contract.tools",
    "packages.cortex_contract.errors",
